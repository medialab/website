  ...
  return (
    <div className="container">
      ...
      <Switch>
        ...
        <Route
          path="/activities/:id"
          render={({match}) => <ActivityForm id={match.params.id} />}
        />
        <Route
          path="/activities"
          render={() => (
        ...
        <Route
          path="/people/:id"
          render={({match}) => <PeopleForm id={match.params.id} />}
        />
        <Route
          path="/people"
          render={() => (
        ...
        <Route
          path="/news/:id"
          render={({match}) => <NewsForm id={match.params.id} />}
        />
        <Route
          path="/news"
          render={() => (
            <List key="news" model="news" label="news" specs={listSpecs.news} />
          )}
        />
        <Route path="/productions/new" render={() => <ProductionForm />} />
        <Route
          path="/productions/:id"
          render={({match}) => <ProductionForm id={match.params.id} />}
        />
        <Route
          path="/productions"
          render={() => (
        ...
        <Route
          path="/settings"
          render={() => <SettingsForm key="settings" />}
        />
