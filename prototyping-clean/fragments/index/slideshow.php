<section class="slideshow" id="slideshow">
			...
			<label class="slideshow--bullet-label" for="ss1-item-1">Rencontre avec George Micheal</label>
						...
						<div class="contenu-slide">
							<a href="#">
								<div class="nomenclature">
									<p class="type"><a href="#">Actualité</a></p>
								...
								<p class="description">Georgios Kyriacos Panayiotou, connu sous le nom de scène de George Michael, est un auteur-compositeur-interprète et producteur britannique, né le 25 juin 1963 à Londres et mort le 25 décembre 2016 à Goring-on-Thames.</p>					
			...
			<label class="slideshow--bullet-label" for="ss1-item-2">Marchés financiers : que sont les “bonnes” relations sociales d’échange?</label>
			<div class="slideshow--item">
				<article class="transition" data-type="activite">
					...
					<div class="contenu-slide">
						<a href="#">
							<div class="nomenclature">
								<p class="type"><a href="#">Activité</a></p>
			...
			<label class="slideshow--bullet-label" for="ss1-item-3">Hyperlink is not dead!</label>
			<div class="slideshow--item">
				<article class="transition" data-type="production">
					...
					<div class="contenu-slide">
						<a href="#">
							<div class="nomenclature">
								<p class="type"><a href="#">Production</a></p>
							...
							<p class="description">Le 4 octobre, le premier Digital Tools & Uses Congress s’est tenu à la MSH Paris Nord autour des usages et développements des outils numériques. Invité pour une Keynote intitulée Hyperlink is not dead!, Benjamin Ooghe a présenté le rôle central et structural de l’hyperlien dans l’étude du web en SHS, notamment à travers l’exemple de l’outil Hyphe développé au médialab.</p>					
							<p class="more"><a href="#">En savoir plus</a></p>
						</a>
					</div>
				</article>
