...
<aside class="container" id="elements-associes">
    ...
    <input type="checkbox" id="filtre_equipe" class="filtre_objet" checked/>
    <label for="filtre_equipe">Équipe</label>
    <input type="checkbox" id="filtre_production" class="filtre_objet" checked/>
    <label for="filtre_production">Production</label>
	<input type="checkbox" id="filtre_activite" class="filtre_objet" checked/>
    ...
    <div class="contenu">
        ...
        <!-- if type=people -->
        <article data-type="people" class="people" class="people">
