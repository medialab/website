...
var Hi=fe(function(){var a="ol";X.mark&&(0==a.lastIndexOf("mark_",0)||(a="mark_"+a),X.mark(a));var b=String(R("time_service_mode")||""),c=y("ytcsi.now");a=Jh();b=b&&c&&c()||N();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=qh();if(b=a.ol)tf(b),a.ol=0;Fh().tick_ol=void 0;N();Gh()?(a=Hh(),kh("tick_ol_"+a)||hh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},void 0),a=!0):a=!1;if(a=!a)a=!y("yt.timing.pingSent_");if(a&&(b=P("TIMING_ACTION",void 0),a=Jh(),y("ytglobal.timingready_")&&b&&a._start&&
(b=Ih()))){Ch||(ph(uh,new sh(Math.round(b-a._start),void 0)),Ch=!0);b=!0;c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Lh()}a=ui.getInstance();c=!!((xi("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Sc(document.body,"exp-invert-logo")&&(b&&!Sc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Sc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")):
!b&&Sc(document.body,"inverted-hdpi")&&Tc());c!=b&&(c="f"+(Math.floor(119/31)+1),d=xi(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),Ii=fe(function(){var a=yi;
