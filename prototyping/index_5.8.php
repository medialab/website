...
<head>
    ...
    <link rel='stylesheet' type='text/css' href='assets/css-compiled/index_5.8.css'>
...
<body>
	...
	<div class="i1" >
		...
		<div class="container">
			...
			<section id="enavant">
				...
				<header class="actualite" data-attribute="annonce">
					<div class="image">
						<?php include('assets/images/sample_txt/naturpradi_xl.html'); ?>
					</div>
					<div class="title">
		...
		<div class="container">
			...
			<div id="agenda_moving_right">
				<span>◁</span>
			</div>
			<div id="agenda" data-attribute="agenda">
				<div class="day past" data-attribute="day">
					<h4>How not to be a bad designer</h4>

					<p class="date start"><span>Mardi</span> 01 Janvier</p>
				...
				<div class="day past" data-attribute="day">
					...
					<p class="date start"><span>Jeudi</span> 02 Janvier</p>
					<div class="agenda_detail_container">
						<p class="horaire start">10:00</p>
						<p class="horaire end">18:00</p>
					</div>
