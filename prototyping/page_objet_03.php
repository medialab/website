...
<head>
    ...
    <link rel='stylesheet' type='text/css' href='assets/css-compiled/page_objet_03.css'>
...
<body>
	...
	<article>
		<nav id="boussole">
			<ul>
				<li>
					<a href="#objet_majeur"">Article</a>
				</li>
				<li>
					<a href="#rel_personnes">Personnes liées</a>
				</li>
				<li>
					<a href="#rel_publications">Publications liées</a>
				</li>
		...
		<main id="objet_majeur">
			...
			<section>
    			...
    			<img src="_bac_a_sable/pessoa.jpg" alt="" />
		...
		<section id="rel_publications">
			<div>
				<header>
					<h2>Publication en lien </h2>
				</header>
