...
import MenuCircle from '../svg/MenuCircle';
...
const Link = props => (
  <BasicLink partiallyActive activeClassName={'active'} {...props} />
);
  ...
  return (
    <header id="topbar" role="banner" aria-label={ariaLabelI18n[lang].header}>
      ...
      <label htmlFor="toggle-menu">
        <span
          className="span-nochecked"
          aria-label={ariaLabelI18n[lang].openMenu}>
          <MenuCircle />
        </span>
        <span
          className="span-checked"
          aria-label={ariaLabelI18n[lang].closeMenu}>
          <CloseCircle />
        </span>
      </label>
      ...
      <div id="topbar-content">
        ...
        <nav
          id="nav-option"
          role="navigation"
          aria-owns="langue back_button fr-to-en en-to-fr">
          <ul id="nav-objet">
            <li data-type="actualite">
              <Link
                to={mainPermalinks[lang].news}
                aria-label={ariaLabelI18n[lang].news}>
                {news}
              </Link>
            </li>
            ...
            <li data-type="production">
              <Link
                ...
                aria-label={ariaLabelI18n[lang].productions}>
                {prod}
              </Link>
            </li>
            ...
            <li data-type="activite">
              <Link
                ...
                aria-label={ariaLabelI18n[lang].activities}>
                {activite}
              </Link>
            </li>
          </ul>
          ...
          <ul id="nav-archive">
            ...
            <li>
              <Link
                ...
                aria-label={ariaLabelI18n[lang].tools}>
                {tool}
              </Link>
              {/* <a
            ...
            <li>
              <Link
                to={mainPermalinks[lang].seminar}
                aria-label={ariaLabelI18n[lang].seminar}>
                {seminar}
              </Link>
            </li>
        ...
        <div
          id="langue"
          className="menu langue"
          aria-label={ariaLabelI18n[lang].lang}>
          <p>
            <BasicLink
      ...
      <div className="print">
        <p itemProp="url">medialab.sciencespo.fr</p>
      </div>
    </header>
  );
}
