...
export default function Agenda({rdv, lang}) {
  return (
    <section id="agenda">
      <h1>{i18n[lang].rdv}</h1>
      <input id="checkbox_agenda" type="checkbox" name="checkbox_flux" hidden />
          ...
          <article
            ...
            <Link to={event.permalink[lang]} aria-label={i18n[lang].more}>
              <aside className="divers">
                <p className="label" data-icon="news" itemProp="name">
                  {event.label && event.label[lang]}
                </p>
                <DateNews
                ...
                {event.internal && (
                  <p
                    className="internal"
                    aria-label={i18n[lang].internal}
                    title={i18n[lang].internal}>
                    ⌂
                  </p>
                )}
              </aside>
              ...
              <h1 data-level-1="title">
                <LanguageFallback
                  translatedAttribute={event.title}
                  lang={lang}
                />
              </h1>
