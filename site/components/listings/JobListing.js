...
const messagesMeta = {
  title: {
    fr: 'Recrutement | médialab Sciences Po',
    en: 'Jobs | médialab Sciences Po'
  },
  description: {
    fr: "offres d'emploi du médialab",
    en: 'job offers from the médialab'
  }
};
...
export default function NewsListing({lang, list, onlyJobs}) {
  ...
  if (onlyJobs) {
    list = list.filter(news => {
      return (
        news.label &&
        (news.label.fr === 'Emploi' || news.label.en === 'Job') &&
        !news.endDate
      );
    });
  }
  ...
  return (
    <>
      ...
      <main role="main" aria-describedby="aria-accroche">
        <NewsFilter
          lang={lang}
          years={Array.from(yearGroups.keys()).sort(byYearKey)}
          label="jobs"
          hideTypeFilter
        />
                      ...
                      <Link to={news.permalink[lang]}>
                        <div className="image-pre" aria-hidden="true">
                          <ProcessedImage
                            ...
                            image={
                              news.coverImage &&
                              news.coverImage.processed.medium
                            }
                          />
                        </div>
                        <div className="bandeau">
                          ...
                          <p className="label-news">
                            <LanguageFallback
                              lang={lang}
                              translatedAttribute={news.label}
                            />
                          </p>
                          <div>
                            <DateNews
                        ...
                        <div className="accroche">
                          <p
                            ...
                            className="accroche-paragraphe">
                            <LanguageFallback
                              lang={lang}
                              translatedAttribute={news.description}
                            />
                          </p>
                        </div>
                      </Link>
