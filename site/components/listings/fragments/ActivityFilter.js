...
const ActivityFilter = ({lang}) => {
  ...
  return (
    <>
      <h1 className="type_title" data-icon="activite">
        <a href="#liste">{I18N_MODEL[lang].activities}</a>
      </h1>
      ...
      <input
        type="checkbox"
        id="filtre-activity_active"
        name="filtre-activity_active"
        className="input_filtre-activity filtre-activity_statut"
        value="active"
        defaultChecked
        hidden
      />
      <input
        type="checkbox"
        id="filtre-activity_past"
        name="filtre-activity_past"
        className="input_filtre-activity filtre-activity_statut"
        value="past"
        hidden
      />
      <input
        type="checkbox"
        id="filtre-activity_research"
        name="filtre-activity_research"
      ...
      <input
        type="checkbox"
        id="filtre-activity_teaching"
        name="filtre-activity_teaching"
        className="input_filtre-activity filtre-activity_type"
        value="teaching"
        hidden
      />
      ...
      <aside className="aside-filters" aria-label={filtersTitle}>
        ...
        <div className="filter-group" aria-label={filterStatus}>
          ...
          <label
            id="filtre-activity_active_label"
            className="filtre-activity checkbox-medialab"
            htmlFor="filtre-activity_active"
            aria-label={activeActivity}>
            {activeActivity}
          </label>
          <label
            id="filtre-activity_past_label"
            className="filtre-activity checkbox-medialab"
            htmlFor="filtre-activity_past"
            aria-label={pastActivity}>
            {pastActivity}
          </label>
        </div>
        ...
        <div className="filter-group" aria-label={filterType}>
          ...
          <label
            id="filtre-activity_research_label"
            className="filtre-activity checkbox-medialab"
            htmlFor="filtre-activity_research"
            aria-label={I18N_TYPE_LABELS.activities[lang].research}>
            {I18N_TYPE_LABELS.activities[lang].research}
          </label>
          <label
            id="filtre-activity_teaching_label"
            className="filtre-activity checkbox-medialab"
