  ...
  return (
    <>
      <h1 className="type_title">
        <a href="#liste_equipe">{I18N_MODEL[lang].people}</a>
      </h1>

      <input
        type="radio"
        id="radio-phone-filters"
        name="radio-phone"
        value="filters"
        hidden
      />
      <label
        htmlFor="radio-phone-filters"
        title={filtersAlt}
        arial-label={filtersAlt}>
        <Icons icon="search-filter" />
      </label>

      <input
        type="radio"
        id="radio-phone-infos"
        name="radio-phone"
        value="infos"
        hidden
      />
      <label
        htmlFor="radio-phone-infos"
        title={infosAlt}
        arial-label={infosAlt}>
        <Icons icon="infos" />
      </label>

      <input
        type="radio"
        id="radio-phone-close"
        name="radio-phone"
        value="close"
        hidden
      />
      <label
        htmlFor="radio-phone-close"
        title={closeAlt}
        arial-label={closeAlt}>
        ✕
      </label>

      <aside className="accroche-title-list">
        <h1 className="aside-title" data-icon="activite">
          {I18N_MODEL[lang].people}
        </h1>
      ...
      <input
        type="checkbox"
        id="filtre_non_membre"
        name="filtre_non_membre"
        className="input_member"
        value="non_membre"
        hidden
      />
      ...
      <input
        type="checkbox"
        id="domaine_academique"
        name="domaine_academique"
      ...
      <input
        type="checkbox"
        id="domaine_administratif"
        name="domaine_administratif"
        className="input_domaine"
        value="administratif"
        hidden
      />
      ...
      <aside
        className="aside-filters"
        role="navigation"
        aria-label={filtresTitle}>
        ...
        <div className="filter-group" aria-label={filterMember}>
          <h1>{filterMember}</h1>
          <label
            id="filtre_membre_label"
            className="checkbox-medialab"
            htmlFor="filtre_membre"
            aria-label={member}>
            {member}
          </label>
          <label
            id="filtre_non_membre_label"
            className="checkbox-medialab"
            htmlFor="filtre_non_membre"
            aria-label={associate}>
            {associate}
          </label>
          <label
            id="filtre_invite_label"
            className="checkbox-medialab"
            htmlFor="filtre_invite"
            aria-label={invited}>
            {invited}
          </label>
        </div>
        ...
        <div className="filter-group" aria-label={filterDomain}>
          <h1>{filterDomain}</h1>
          <label
            id="domaine_academique_label"
            className="checkbox-medialab"
            htmlFor="domaine_academique"
            aria-label={I18N_TYPE_LABELS.people[lang].academic}>
            {I18N_TYPE_LABELS.people[lang].academic}
          </label>
          <label
            id="domaine_technique_label"
            className="checkbox-medialab"
            htmlFor="domaine_technique"
            aria-label={I18N_TYPE_LABELS.people[lang].tech}>
            {I18N_TYPE_LABELS.people[lang].tech}
          </label>
          <label
            id="domaine_design_label"
            className="checkbox-medialab"
            htmlFor="domaine_design"
            aria-label={I18N_TYPE_LABELS.people[lang].design}>
            {I18N_TYPE_LABELS.people[lang].design}
          </label>
          <label
            id="domaine_administratif_label"
            className="checkbox-medialab"
            htmlFor="domaine_administratif"
            aria-label={I18N_TYPE_LABELS.people[lang].admin}>
            {I18N_TYPE_LABELS.people[lang].admin}
          </label>
        </div>
      </aside>
    </>
