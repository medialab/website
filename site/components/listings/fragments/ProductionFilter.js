...
function LabelFiltresType({lang, group}) {
  ...
  return (
    <div
      ...
      aria-label={i18n[lang].filtresLabel}>
...
export default function ProductionFilter({lang, group, types, years}) {
  const {accroche, infosAlt, closeAlt, filtresTitle, filtersAlt} = i18n[lang];

  return (
    <>
      <h1 className="type_title" data-icon="production">
        <a href="#liste">Productions</a>
      </h1>
      ...
      <aside className="aside-filters" aria-label={filtresTitle}>
        ...
        <ul
          id="list-filter-type"
          data-list-open={group}
          className="link-productions-sort"
