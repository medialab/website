      ...
      <>
        ...
        <nav className="main-nav" id="nav-inside-article" role="navigation">
          <ul>
            ...
            <li className="nav-inside-item" data-type="main"><a href="#directeur" title="Aller à la section" > Directeur de la publication</a></li>
            <li className="nav-inside-item" data-type="main"><a href="#host" title="Aller à la section" > Hébergement</a></li>
            <li className="nav-inside-item" data-type="main"><a href="#PI" title="Aller à la section" > Propriété Industrielle et Intellectuelle</a></li>
            <li className="nav-inside-item" data-type="main"><a href="hypertext" title="Aller à la section" > Les liens hypertextes</a></li>
            <li className="nav-inside-item" data-type="main"><a href="#images" title="Aller à la section" > Images</a></li>
            <li className="nav-inside-item" data-type="main"><a href="#IL" title="Aller à la section" > Inform et liberté</a></li>
           </ul>
        </nav>
          <article id="about-contenu" className="main-container">
            <hgroup>
              ...
              <p><b>Le contenu de ce site internet est fourni par :</b>
              Sciences Po
    ...
    return (
      <>
        ...
        <nav className="main-nav" id="nav-inside-article" role="navigation">
          <ul>
            <li className="nav-inside-item" data-type="main"><a href="#main" title="Aller à la section" > Aller en haut</a></li>
            <li className="nav-inside-item" data-type="main"><a href="#publisher" title="Aller à la section" > Publisher</a></li>
            <li className="nav-inside-item" data-type="main"><a href="#host" title="Aller à la section" > Hosting</a></li>
            <li className="nav-inside-item" data-type="main"><a href="#PI" title="Aller à la section" > Industrial and Intellectual Property</a></li>
            <li className="nav-inside-item" data-type="main"><a href="hypertext" title="Aller à la section" > Hypertext Links</a></li>
           </ul>
        </nav>
          <article id="about-contenu" className="main-container">
            <hgroup>
              ...
              <p><b>The contents of this site were supplied by :</b>
              Sciences Po
              27 rue Saint-Guillaume
              75337 Paris Cedex 07
              Tel. : 01 45 49 50 50
