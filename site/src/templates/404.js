  ...
  return (
    <Layout
      ...
      <div className="pattern-container">
        <ProcessedImage size="large" data={{title: {fr: 'oh rage oh désespoir', en: 'desmond toutou'}}} />
      </div>
      <div className="not-found-container">
        <div className="not-found not-found-fr">
          ...
          <p>
            ...
            <br />
            Vous pourrez retrouver tous nos contenus à partir de <Link to="/">l'accueil</Link>.
          </p>
        </div>
        ...
        <div className="not-found not-found-en">
          ...
          <p>
            ...
            <br />
            You can find all our content from the <Link to="/en/">homepage</Link>.
          </p>
        </div>
      </div>
    </Layout>
